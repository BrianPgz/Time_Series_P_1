...
Proponemos la transformación raíz del logaritmo de la serie. 


```{r echo=TRUE}
model3=sqrt(log_S_beer)
bptest(model3 ~ t1)
```
Ganamos que la serie sea homocedástica, entonces podemos proponer un SARIMA. 
